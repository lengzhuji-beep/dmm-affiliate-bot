...
(async () => {
    console.log('Launching browser to scrape recent impressions for @av_favorite_av...');
    ...
    console.log('Navigating to https://x.com/av_favorite_av/with_replies...');
    ...
    console.log('Scrolling and extracting posts...');
